...
function getCustomers() {
    try {
        ...
        const query = 'INSERT INTO example_keyspace.metrics(id, assetid, cpuload, cpuusage, diskusage, memusage) VALUES (?,?,?,?,?,?);';
        const params = [create_UUID(), getrandom(), getrandom(), getrandom(), getrandom(), getrandom()];
